...
from thor.utils.constants import IN_RGB_MEAN, IN_RGB_STD

LOC_SYNSET_MAP_FILE = "ImageNet_class_index.json"  # 'LOC_synset_mapping.txt'
DATA_PATH = "./"  # 'ILSVRC/Data/CLS-LOC/'


@DATASETS.register()
class ImageNetDataset(Dataset):
    def __init__(self, base_path, split="train", standardize=True, load_type="all", input_size=224, **kwargs):
    ...
    def load_file_paths(self, base_path, split, load_type, **kwargs):
        ...
        if load_type == "all":
            ...
            for cl in all_img_classes:
                ...
                num_samples = min(num_samples, len(all_imgs_for_cl))
