...
from thor.utils.pos_embed import get_1d_sincos_pos_embed_from_grid, get_2d_sincos_pos_embed
...
@MODELS.register()
def sat_vit_large_encoder(input_parmas, **kwargs):
    ...
    model_dict = dict(
        ...
        patch_size=input_parmas.get("patch_size", 8),
    ...
    return SatViTEncoder(**model_dict)


@MODELS.register()
def sat_vit_large_rgb_encoder(input_parmas, **kwargs):
    ...
    return SatVitEncoderRGB(**model_dict)
